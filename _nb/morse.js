---
description: |
  Convert to and from morse code. Requires input string '_text_'. Morse code to word conversions must start with '&#46','&#44', or '&#95'. spaces in morse should be '&#95' or '&#124'.
variables:
  - text
tag: functions
order: 5
